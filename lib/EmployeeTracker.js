...
class EmployeeTracker {
  ...
  /**
   * Function to call the Department object's static method to diaplay all departments
   */
  ...
  /**
   * Function to call the Role object's static method to diaplay all roles
   */
  async viewAllRoles() {
  ...
  /**
   * Function to call the Employee object's static method to diaplay all employees and the budget for the entire organization
   */
  ...
  /**
   * Function to prompt the user about creating a new department
   */
  async addDepartment() {
  ...
  /**
   * Function to prompt the user about creating a new role within a department
   */
  async addRole() {
    ...
    await inquirer.prompt(questions).then(async (answers) => {
      await Role.add(answers.title, parseFloat(answers.salary), answers.department);
    });
  ...
  /**
   * Function to prompt the user about creating a new employee
   */
  async addEmployee() {
  ...
  /**
   * Function to prompt the user about updating an employee's role
   */
  ...
  /**
   * Function to prompt the user about updating an employee's manager
   */
  ...
  /**
   * Function to prompt the user about viewing a manager's employees
   */
  ...
  /**
   * Function to prompt the user about viewing a department's employees
   */
  ...
  /**
   * Function to prompt the user about deleting a department
   */
  ...
  /**
   * Function to prompt the user about deleting a role
   */
  async deleteRole() {
    // a formatted table showing employee data, including employee ids, first names, last names, job titles, departments, salaries, and managers that the employees report to
    console.log("\n------ Delete a Role ------");
  ...
  /**
   * Function to prompt the user about deleting an employee
   */
